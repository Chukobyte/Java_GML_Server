...
//    if(size_in_bytes >= header_stuff + packet_size) {       
    ...
    if(magic_number == MAGIC_NUMBER) {    
        ...
        switch(message_id) {
            ...
            case UPDATE_RESPONSE:
                ...
                if(new_board_array != noone) {
                    ...
                    success = false;
                    buffered_message_id = UPDATE_RESPONSE;
            ...
            case GET_USERS_ONLINE_RESPONSE:
                ...
                if(online_users_map != noone) {
                    ...
                    success = false;
                    buffered_message_id = GET_USERS_ONLINE_RESPONSE;
                    buffering_messages = true;
                }
        ...
        response_buffered_messages += buffer_read(buffer, buffer_string);
        show_debug_message("Updated Message = " + response_buffered_messages);
        
        switch(buffered_message_id) {
            case UPDATE_RESPONSE:
                var new_board_array = json_decode_two_dimensional_array(response_buffered_messages);
        ...
        //TODO: Need to handle if not magic number?
        ///*
